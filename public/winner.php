...
<div class="container-fluid">
    ...
    while ($row = $req->fetch_assoc()) {
        echo "<div class='col-xs-offset-1 col-xs-3'>" .$row['last_name']. " " .$row['first_name']. "</br> Twitter :".$row['twitter']. "</br>" .$row['likes']. "</br><img class='winner' src=\"../src/" .$row['picture_url']. "\"/></div>" ;
    }
